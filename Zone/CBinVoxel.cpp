...
bool CBinVoxel::ChunkToData()
{
	// ZONEBOUDNS
	{
		...
		while (chunkDataSize > 0)
		{
			...
			g_LogDummy.ILog("ZoneId: %d, ZoneOrigin: (%f, %f, %f), BoundsExtentMin: (%f, %f, %f), BoundsExtentMax: (%f, %f, %f)",
				info.ZoneId,
	...
	// Grid
	{
		...
		while (chunkDataSize > 0)
		{
			...
			g_LogDummy.ILog("GridOrigin: (%f, %f, %f), VoxelSize: %f, GridSize: (%d, %d, %d), ChunkSize: (%d, %d, %d)",
